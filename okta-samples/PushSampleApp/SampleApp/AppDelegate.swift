...
private enum PushSettingsConstant {
    static let applicationGroupID = "group.group.ai.trusources.trukycdemo"
...
enum LoggerEvent: String {
    case appInit, pushService, webSignIn, enrollment, enrollmentDelete, userVerification, ciba, account, trukyc
}
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication,
        ...
        // Your code to handle the background received notification goes here

        print("Received remote notification: \(userInfo)")

        // Call the completion handler when done
        completionHandler(.noData) // or .newData if you fetched any data, or .failed on failure
    }
